...
const SideBar = () => {
    return (
        <div className="absolute h-96 z-100 top-0 left-0  w-16 flex flex-col xs:mb-96 sm:mb-96
        bg-backgroundWork shadow-lg xl:flex-row xl:justify-around xl:h-16 xl:w-full xl:inset-x-0 lg:flex-row lg:justify-around lg:h-16 lg:w-full lg:inset-x-0">
